...
`);let f="";return l<2&&a>0?f="coords":f=n.shapeInfo.logicalShape.map((m,g)=>`coords.${p[g+h]}`).join(", "),`
  ...
  `}function Pe(n){if(n<=1)return"int";if(n===2)return"ivec2";if(n===3)return"ivec3";if(n===4)return"ivec4";if(n===5)return"ivec5";if(n===6)return"ivec6";throw Error(`GPU for rank ${n} is not yet supported`)}function ap(n,e,t){const{newShape:s,keptDims:o}=as(e),r=e.length,i=n&&r===3&&e[0]===1,a=i?e.slice(1):s,l=!n&&r>1&&!Re(e,t)&&s.length<r||i;return{useSqueezeShape:l,uniformShape:l?a:e,keptDims:o}}function er(n,e){const t=JSON.parse(JSON.stringify(n));return t.shapeInfo.logicalShape=e,t}function tr(n,e){return e.map(t=>n[t]).join(", ")}function KM(n,e,t,s){const o=t.map((u,h)=>{const d={logicalShape:u.shape,texShape:u.isUniform?null:u.texData.texShape,isUniform:u.isUniform,isPacked:u.isUniform?!1:u.texData.isPacked,flatOffset:null};return u.texData!=null&&u.texData.slice!=null&&u.texData.slice.flatOffset>0&&(d.flatOffset=u.texData.slice.flatOffset),{name:e.variableNames[h],shapeInfo:d}}),r=o.map(u=>u.shapeInfo),i={logicalShape:s.shape,texShape:s.texData.texShape,isUniform:!1,isPacked:s.texData.isPacked,flatOffset:null},a=dM(o,i,e),l=VL(n.gl,a),c=n.createProgram(l);return V().get("ENGINE_COMPILE_ONLY")?{program:e,fragmentShader:l,source:a,webGLProgram:c,inShapeInfos:r,outShapeInfo:i,variablesLocations:null,customUniformLocations:null,infLoc:null,nanLoc:null,outShapeLocation:null,outShapeStridesLocation:null,outTexShapeLocation:null}:(n.buildVao(c),Object.assign({program:e,fragmentShader:l,source:a,webGLProgram:c,inShapeInfos:r,outShapeInfo:i},B1(n,e,c)))}function B1(n,e,t){const s=[],o=[];let r,i,a,l=null,c=null;c=n.getUniformLocation(t,"NAN",!1),V().getNumber("WEBGL_VERSION")===1&&(l=n.getUniformLocation(t,"INFINITY",!1));const u=!1;for(const h of e.variableNames){const d={name:h,uniform:n.getUniformLocation(t,h,u),offset:n.getUniformLocation(t,`offset${h}`,u)};e.enableShapeUniforms&&(d.shape=n.getUniformLocation(t,`${h}Shape`,u),d.texShape=n.getUniformLocation(t,`${h}TexShape`,u)),s.push(d)}if(e.enableShapeUniforms&&(r=n.getUniformLocation(t,"outShape",u),a=n.getUniformLocation(t,"outShapeStrides",u),i=n.getUniformLocation(t,"outTexShape",u)),e.customUniforms)for(const h of e.customUniforms)o.push(n.getUniformLocation(t,h.name,u));return{variablesLocations:s,customUniformLocations:o,infLoc:l,nanLoc:c,outShapeLocation:r,outShapeStridesLocation:a,outTexShapeLocation:i}}function z1(n,e){if(n.length!==e.length)throw Error(`Binary was compiled with ${n.length} inputs, but was executed with ${e.length} inputs`);n.forEach((t,s)=>{const o=t.logicalShape,r=e[s],i=r.shape;if(!Re(o,i))throw Error(`Binary was compiled with different shapes than the current args. Shapes ${o} and ${i} must match`);if(t.isUniform&&r.isUniform)return;const a=t.texShape,l=r.isUniform?null:r.texData.texShape;if(!Re(a,l))throw Error(`Binary was compiled with different texture shapes than the current args. Shape ${a} and ${l} must match`)})}function XM(n,e,t,s,o){e.program.enableShapeUniforms||(z1(e.inShapeInfos,t),z1([e.outShapeInfo],[s]));const r=s.texData.texture,i=s.texData.texShape;s.texData.isPacked?n.setOutputPackedMatrixTexture(r.texture,i[0],i[1]):n.setOutputMatrixTexture(r.texture,i[0],i[1]),n.setProgram(e.webGLProgram),n.bindVertexArray(e.webGLProgram.vao),V().getNumber("WEBGL_VERSION")===1&&e.infLoc!==null&&n.gl.uniform1f(e.infLoc,1/0),e.nanLoc!==null&&n.gl.uniform1f(e.nanLoc,NaN);for(let l=0;l<t.length;++l){const c=t[l],{uniform:u,offset:h,shape:d,texShape:p}=e.variablesLocations[l];if(d){const{uniformShape:f}=ap(e.program.packedInputs,c.shape,c.texData.texShape);switch(f.length){case 1:n.gl.uniform1iv(d,new Int32Array(f));break;case 2:n.gl.uniform2iv(d,new Int32Array(f));break;case 3:n.gl.uniform3iv(d,new Int32Array(f));break;case 4:n.gl.uniform4iv(d,new Int32Array(f));break}}if(p&&n.gl.uniform2i(p,c.texData.texShape[0],c.texData.texShape[1]),u!=null){if(c.isUniform){if(j(c.shape)<2)n.gl.uniform1f(u,c.uniformValues[0]);else{let f=c.uniformValues;f instanceof Float32Array||(f=new Float32Array(f)),n.gl.uniform1fv(u,f)}continue}c.texData.slice!=null&&h!=null&&n.gl.uniform1i(h,c.texData.slice.flatOffset),n.setInputMatrixTexture(c.texData.texture.texture,u,l)}}const a=e.outShapeLocation;if(a)switch(s.shape.length){case 1:n.gl.uniform1iv(a,new Int32Array(s.shape));break;case 2:n.gl.uniform2iv(a,new Int32Array(s.shape));break;case 3:n.gl.uniform3iv(a,new Int32Array(s.shape));break;case 4:n.gl.uniform4iv(a,new Int32Array(s.shape));break}if(e.outShapeStridesLocation){const l=he(s.shape);switch(s.shape.length){case 2:n.gl.uniform1iv(e.outShapeStridesLocation,new Int32Array(l));break;case 3:n.gl.uniform2iv(e.outShapeStridesLocation,new Int32Array(l));break;case 4:n.gl.uniform3iv(e.outShapeStridesLocation,new Int32Array(l));break}}if(e.outTexShapeLocation&&n.gl.uniform2i(e.outTexShapeLocation,s.texData.texShape[0],s.texData.texShape[1]),e.program.customUniforms&&o)for(let l=0;l<e.program.customUniforms.length;++l){const c=e.program.customUniforms[l],u=e.customUniformLocations[l],h=o[l];if(c.type==="float")n.gl.uniform1fv(u,h);else if(c.type==="vec2")n.gl.uniform2fv(u,h);else if(c.type==="vec3")n.gl.uniform3fv(u,h);else if(c.type==="vec4")n.gl.uniform4fv(u,h);else if(c.type==="int")n.gl.uniform1iv(u,h);else if(c.type==="ivec2")n.gl.uniform2iv(u,h);else if(c.type==="ivec3")n.gl.uniform3iv(u,h);else if(c.type==="ivec4")n.gl.uniform4iv(u,h);else throw Error(`uniform type ${c.type} is not supported yet.`)}n.executeProgram()}function YM(n,e,t){let s="";e.concat(t).forEach(i=>{const a=i.texData!=null&&i.texData.slice!=null&&i.texData.slice.flatOffset>0;if(n.enableShapeUniforms&&!i.isUniform){const l=i.texData.texShape,{useSqueezeShape:c,uniformShape:u,keptDims:h}=ap(n.packedInputs,i.shape,l);let d="",p="",f="";if(u.length===1&&n.packedInputs){const C=[Math.ceil(l[0]/2),Math.ceil(l[1]/2)];d=`${C[0]>1}_${C[1]>1}`}else if(u.length===2&&!n.packedInputs)p=`${u[0]>1}_${u[1]>1}`;else if(u.length>2&&!n.packedInputs){const C=he(u);f=`${C[0]===l[1]}_${C[C.length-1]===l[1]}`}const m=i.shape.length,g=u.length===2&&Re(i.shape,l),x=j(i.shape)===1,b=Oo(i.shape,t.shape),w=!n.packedInputs&&m===t.shape.length&&Re(l,t.texData.texShape),y=n.packedInputs||u.length>2?"":`${l[0]>1}_${l[1]>1}`;s+=`${m}_${w}_${c?h:""}_${u.length}_${x}_${b}_${g}_${d}_${p}_${f}_${y}_${a}`}else{const l=i.isUniform?"uniform":i.texData.texShape;s+=`${i.shape}_${l}_${a}`}});const o=n.userCode;let r=n.constructor.name;return r+="_"+s+"_"+o+`${V().getNumber("WEBGL_VERSION")}`,r}function At(n){return V().getBool("WEBGL_USE_SHAPES_UNIFORMS")&&n<=4}class ZM{constructor(e){this.variableNames=["A"],this.packedInputs=!1,this.packedOutput=!0,this.outPackingScheme=Bi.DENSE,this.customUniforms=[{name:"texShape",type:"ivec2"}];const t=Ot();this.outputShape=e,this.enableShapeUniforms=At(this.outputShape.length),this.userCode=`
    ...
    `}}const tP={R:0,G:1,B:2,A:3};class V1{constructor(e,t=!1,s="RGBA"){this.variableNames=["A"],this.customUniforms=[{name:"texShape",type:"ivec2"}];const o=Ot();this.outputShape=e,this.enableShapeUniforms=At(this.outputShape.length);let r="result";t&&(r="floor(result * 255. + 0.5)");let i="";for(let a=0;a<s.length;a++){const l=s[a];i+=`
      ...
      ${this.enableShapeUniforms?ip():rp(e)}
...
`;function V3(n){const{inputs:e,backend:t}=n,{x:s,alpha:o}=e,r=V().getBool("WEBGL_PACK_BINARY_OPERATIONS")?new nr(ry,s.shape,o.shape):new go(oy,s.shape,o.shape);return t.runWebGLProgram(r,[s,o],"float32")}const W3={kernelName:Ma,backendName:"webgl",kernelFunc:V3};const sr="if (isnan(x)) return x;";function Ne({opSnippet:n,packedOpSnippet:e,cpuKernelImpl:t,dtype:s}){return({inputs:o,backend:r})=>{const{x:i}=o,a=r,l=s||i.dtype;if(a.shouldExecuteOnCPU([i])&&t!=null){const h=a.texData.get(i.dataId),d=t(h.values,l);return a.makeTensorInfo(i.shape,l,d)}const c=V().getBool("WEBGL_PACK_UNARY_OPERATIONS")&&e!=null;let u;return c?u=new Rs(i.shape,e):u=new Kn(i.shape,n),a.runWebGLProgram(u,[i],l)}}function $t({opSnippet:n,packedOpSnippet:e,checkOutOfBounds:t=!1,supportsComplex:s=!1,cpuKernelImpl:o,dtype:r}){return({inputs:i,backend:a})=>{const{a:l,b:c}=i,u=a;if(s&&l.dtype==="complex64"){const f=u.texData.get(l.dataId),m=u.texData.get(c.dataId),[g,x]=[[f.complexTensorInfos.real,m.complexTensorInfos.real],[f.complexTensorInfos.imag,m.complexTensorInfos.imag]].map(w=>{const[y,C]=w,$={dataId:y.dataId,dtype:y.dtype,shape:l.shape},v={dataId:C.dataId,dtype:C.dtype,shape:c.shape},T=new go(n,l.shape,c.shape);return u.runWebGLProgram(T,[$,v],Gt(y.dtype,C.dtype))}),b=As({inputs:{real:g,imag:x},backend:u});return u.disposeIntermediateTensorInfo(g),u.disposeIntermediateTensorInfo(x),b}const h=r||Gt(l.dtype,c.dtype);if((l.dtype==="string"||c.dtype==="string"||u.shouldExecuteOnCPU([l,c]))&&o!=null){const f=u.texData.get(l.dataId).values,m=u.texData.get(c.dataId).values,g=l.dtype==="string"?ss(f):f,x=l.dtype==="string"?ss(m):m,[b,w]=o(l.shape,c.shape,g,x,h),y=u.makeTensorInfo(w,h),C=u.texData.get(y.dataId);return C.values=b,y}const d=V().getBool("WEBGL_PACK_BINARY_OPERATIONS")&&e!=null;let p;return d?p=new nr(e,l.shape,c.shape,t):p=new go(n,l.shape,c.shape),u.runWebGLProgram(p,[l,c],h)}}function Ui(n,e=!1){if(n==="linear")return e?$3:b3;if(n==="relu")return e?k3:w3;if(n==="elu")return e?v3:y3;if(n==="relu6")return e?S3:C3;if(n==="prelu")return e?ry:oy;if(n==="leakyrelu")return e?sy:ny;if(n==="sigmoid")return e?N3:I3;throw new Error(`Activation ${n} has not been implemented for the WebGL backend.`)}class iy{constructor(e,t,s,o=!1,r=!1,i=!1,a=null,l=!1,c=!1){this.variableNames=["matrixA","matrixB"],this.packedInputs=!0,this.packedOutput=!0,this.outputShape=s,this.enableShapeUniforms=At(this.outputShape.length);const u=o?e[1]:e[2],h=Math.ceil(u/2),d=o?"i * 2, rc.y":"rc.y, i * 2",p=r?"rc.z, i * 2":"i * 2, rc.z",f=o?["a.xxyy","a.zzww"]:["a.xxzz","a.yyww"],m=r?["b.xzxz","b.ywyw"]:["b.xyxy","b.zwzw"];let g="",x="";a&&(l?g=`vec4 activation(vec4 a) {
    ...
    `}}function yc(n,e,t){const s=V().getBool("WEBGL_PACK_ARRAY_OPERATIONS")?new Y3(n.shape,e):new K3(n.shape,e);return t.runWebGLProgram(s,[n],n.dtype)}function Z3(n,e,t,s){const o=e,r=n.shape.length,i=Ce(o,n.shape);let a=i;const l=Ke(a,r),c=l!=null;let u=n;c&&(u=yc(n,l,s),a=et(a.length,r)),Ct("sum",a,r);const[h,d]=gt(u.shape,a);let p=h;t&&(p=rt(h,i));const f=j(d),g=j(n.shape)/f,x=se({inputs:{x:u},attrs:{shape:[g,f]},backend:s}),b=zu(n.dtype),w=bo(x,b,"sum",s),y=se({inputs:{x:w},attrs:{shape:p},backend:s});return s.disposeIntermediateTensorInfo(x),s.disposeIntermediateTensorInfo(w),c&&s.disposeIntermediateTensorInfo(u),y}function wc(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:r,keepDims:i}=s;return Z3(o,r,i,t)}const Q3={kernelName:Ha,backendName:"webgl",kernelFunc:wc};function Mt(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{perm:r}=s,i=t,a=o.shape.length,l=new Array(a);for(let u=0;u<l.length;u++)l[u]=o.shape[r[u]];let c;if(i.shouldExecuteOnCPU([o])){const h=i.texData.get(o.dataId).values,d=cp(h,o.shape,o.dtype,r,l);c=i.makeTensorInfo(l,o.dtype);const p=i.texData.get(c.dataId);p.values=d}else c=yc(o,r,i);return c}const J3={kernelName:To,backendName:"webgl",kernelFunc:Mt};const hy=1e3;function Cc({a:n,b:e,transposeA:t,transposeB:s,backend:o,bias:r=null,preluActivationWeights:i=null,leakyreluAlpha:a=0,activation:l=null}){const c=n.shape.length,u=e.shape.length,h=t?n.shape[c-2]:n.shape[c-1],d=s?e.shape[u-1]:e.shape[u-2],p=t?n.shape[c-1]:n.shape[c-2],f=s?e.shape[u-2]:e.shape[u-1],m=n.shape.slice(0,-2),g=e.shape.slice(0,-2),x=j(m),b=j(g),y=be(n.shape.slice(0,-2),e.shape.slice(0,-2)).concat([p,f]);k(h===d,()=>`Error in matMul: inner shapes (${h}) and (${d}) of Tensors with shapes ${n.shape} and ${e.shape} and transposeA=${t} and transposeB=${s} must match.`);const C=t?[x,h,p]:[x,p,h],$=s?[b,f,d]:[b,d,f],v=se({inputs:{x:n},backend:o,attrs:{shape:C}}),T=se({inputs:{x:e},backend:o,attrs:{shape:$}}),N=[v,T],S=Math.max(x,b),I=t?v.shape[1]:v.shape[2],R=r!=null,F=i!=null,O=l==="leakyrelu",L=l!=null?Ui(l,!0):null,z=R||F||O||L!=null;let U;if((p===1||f===1)&&I>hy&&z===!1){let H=v,X=T;t&&(H=Mt({inputs:{x:v},backend:o,attrs:{perm:[0,2,1]}}),N.push(H)),s&&(X=Mt({inputs:{x:T},backend:o,attrs:{perm:[0,2,1]}}),N.push(X));const Z=f!==1,G=f===1;let K=H;Z&&(K=se({inputs:{x:H},backend:o,attrs:{shape:[S,I,1]}}),N.push(K));const J=f===1?2:1;let Q=X;G&&(Q=se({inputs:{x:X},backend:o,attrs:{shape:[S,1,I]}}),N.push(Q));const ne=hp({inputs:{a:K,b:Q},backend:o});U=wc({inputs:{x:ne},backend:o,attrs:{axis:J,keepDims:!0}}),N.push(ne)}else{const H=Gt(n.dtype,e.dtype),X=new iy(C,$,[S,p,f],t,s,R,L,F,O),Z=[v,T];if(r!=null&&Z.push(r),F&&Z.push(i),O){const G=o.makeTensorInfo([],"float32",cs(a,"float32"));Z.push(G),N.push(G)}U=o.runWebGLProgram(X,Z,H)}const W=se({inputs:{x:U},backend:o,attrs:{shape:y}});N.push(U);for(const H of N)o.disposeIntermediateTensorInfo(H);return W}function eB(n){const{inputs:e,backend:t,attrs:s}=n,{a:o,b:r,bias:i,preluActivationWeights:a}=e,{transposeA:l,transposeB:c,activation:u,leakyreluAlpha:h}=s;return Cc({a:o,b:r,transposeA:l,transposeB:c,backend:t,bias:i,preluActivationWeights:a,leakyreluAlpha:h,activation:u})}const tB={kernelName:Qa,backendName:"webgl",kernelFunc:eB};const dy="return abs(x);";function nB(n){const{inputs:e,backend:t}=n,{x:s}=e;if(t.shouldExecuteOnCPU([s])&&s.dtype!=="complex64"){const r=t.texData.get(s.dataId),i=K1(r.values);return t.makeTensorInfo(s.shape,s.dtype,i)}let o;return V().getBool("WEBGL_PACK_UNARY_OPERATIONS")?o=new Rs(s.shape,dy):o=new Kn(s.shape,dy),t.runWebGLProgram(o,[s],s.dtype)}const sB={kernelName:Qi,backendName:"webgl",kernelFunc:nB};const oB=fn+`
  if (abs(x) > 1.) {
    return NAN;
  }
  return acos(x);
...
`,SB=Ne({opSnippet:kB}),NB={kernelName:cr,backendName:"webgl",kernelFunc:SB};const TB=fn+"return log(x + sqrt(x * x + 1.0));",EB=Ne({opSnippet:TB}),RB={kernelName:ur,backendName:"webgl",kernelFunc:EB};const AB=fn+`
  return atan(x);
`,DB=Ne({opSnippet:AB}),FB={kernelName:hr,backendName:"webgl",kernelFunc:DB};const _B=up+`
  return atan(a, b);
`,OB=`
...
return (log(1.0 + x) - log(1.0 - x)) / 2.0;`,BB=Ne({opSnippet:PB}),zB={kernelName:dr,backendName:"webgl",kernelFunc:BB};class Gi{constructor(e,t,s,o=!1,r=!1){if(this.variableNames=["x"],t==="avg"&&s)throw new Error("Cannot compute positions for average pool.");const i=e.filterWidth,a=e.strideHeight,l=e.strideWidth,c=e.dilationHeight,u=e.dilationWidth,h=e.effectiveFilterHeight,d=e.effectiveFilterWidth,p=e.padInfo.top,f=e.padInfo.left;this.outputShape=e.outShape;const m=t==="avg",g=`((batch  * ${e.inHeight} + xR) * ${e.inWidth} + xC) * ${e.inChannels} + d`,x=`(xR * ${e.inWidth} + xC) * ${e.inChannels} + d`;let b="0.0";if(m||(b="-1.0 / 1e-20"),s){this.userCode=`
    ...
    `}}function jB(n){const{inputs:e,backend:t,attrs:s}=n,{dy:o,input:r}=e,i=r,{filterSize:a,strides:l,pad:c,dimRoundingMode:u}=s,h=[1,1,1],d=Zn(i.shape,a,l,h,c,u),p=new qB(d);return t.runWebGLProgram(p,[o],i.dtype)}const KB={kernelName:jc,backendName:"webgl",kernelFunc:jB};function XB(n){const{inputs:e,backend:t,attrs:s}=n,{dy:o,input:r}=e,i=r;Vi([o,r],"avgPoolGrad");const{filterSize:a,strides:l,pad:c}=s,u=on(i.shape,a,l,1,c),h=new HB(u);return t.runWebGLProgram(h,[o],i.dtype)}const YB={kernelName:qc,backendName:"webgl",kernelFunc:XB};function ZB(n){const{inputs:e,backend:t,attrs:s}=n,{a:o,b:r}=e,{transposeA:i,transposeB:a}=s;return Cc({a:o,b:r,transposeA:i,transposeB:a,backend:t})}const QB={kernelName:sa,backendName:"webgl",kernelFunc:ZB};class JB{constructor(e,t,s,o,r,i){this.outputShape=[],this.variableNames=["x","mean","variance"],be(e,t),be(e,s);let a="0.0";o!=null&&(be(e,o),this.variableNames.push("offset"),a="getOffsetAtOutCoords()");let l="1.0";r!=null&&(be(e,r),this.variableNames.push("scale"),l="getScaleAtOutCoords()"),this.outputShape=e,this.userCode=`
      void main() {
...
`;function dz(n){const{inputs:e,backend:t}=n,{a:s,b:o}=e,r=V().getBool("WEBGL_PACK_BINARY_OPERATIONS"),i=V().getNumber("WEBGL_VERSION");if(t.shouldExecuteOnCPU([s,o])||i===1){const l=t.texData.get(s.dataId).values,c=t.texData.get(o.dataId).values,[u,h]=IP(s.shape,o.shape,l,c,s.dtype),d=t.makeTensorInfo(h,s.dtype),p=t.texData.get(d.dataId);return p.values=u,d}let a;return r?a=new nr(uz,s.shape,o.shape,!1):a=new go(hz,s.shape,o.shape),t.runWebGLProgram(a,[s,o],s.dtype)}const pz={kernelName:Xc,backendName:"webgl",kernelFunc:dz};function fz(n){const{inputs:e,backend:t}=n,{s0:s,s1:o}=e,r=t.readSync(s.dataId),i=t.readSync(o.dataId),a=be(Array.from(r),Array.from(i));return t.makeTensorInfo([a.length],"int32",Int32Array.from(a))}const mz={kernelName:_p,backendName:"webgl",kernelFunc:fz};const xy=$t({opSnippet:"return float(a != b);",cpuKernelImpl:UP,dtype:"bool"}),gz={kernelName:Da,backendName:"webgl",kernelFunc:xy};function Hi(n){const{inputs:e,backend:t}=n,{input:s}=e,o=t.texData.get(s.dataId);return Xt({inputs:{x:o.complexTensorInfos.real},backend:t})}const xz={kernelName:Iu,backendName:"webgl",kernelFunc:Hi};const bz="return float(int(x));";function yz(n,e){const t=new Kn(n.shape,bz),s=e.runWebGLProgram(t,[n],"int32");return{dataId:s.dataId,shape:s.shape,dtype:s.dtype}}function fp(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{dtype:r}=s;if(r==="complex64"){if(o.dtype==="complex64")return Xt({inputs:{x:o},backend:t});const i=nt(o.shape),a=fp({inputs:{x:o},backend:t,attrs:{dtype:"float32"}}),l=As({inputs:{real:a,imag:i},backend:t});return i.dispose(),t.disposeIntermediateTensorInfo(a),l}if(o.dtype==="complex64"){const i=Hi({inputs:{input:o},backend:t}),a=fp({inputs:{x:i},backend:t,attrs:{dtype:r}});return t.disposeIntermediateTensorInfo(i),a}if(!Tp(o.dtype,r)){const i=Xt({inputs:{x:o},backend:t});return{dataId:i.dataId,shape:i.shape,dtype:r}}if(t.shouldExecuteOnCPU([o])){const i=t.texData.get(o.dataId).values,[a,l,c]=$P(i,o.shape,o.dtype,r);return t.makeTensorInfo(a,l,c)}if(r==="int32")return yz(o,t);if(r==="bool"){const i=t.makeTensorInfo([],"bool",kt("bool",1)),l=xy({inputs:{a:o,b:i},backend:t});return t.disposeIntermediateTensorInfo(i),l}throw new Error(`Error in Cast: failed to cast ${o.dtype} to ${r}`)}const wz={kernelName:fr,backendName:"webgl",kernelFunc:fp};const by="return ceil(x);",Cz=Ne({opSnippet:by,packedOpSnippet:by,cpuKernelImpl:vP}),Iz={kernelName:mr,backendName:"webgl",kernelFunc:Cz};class $z{constructor(e){this.variableNames=["A"],this.customUniforms=[{name:"minVal",type:"float"},{name:"maxVal",type:"float"}],this.outputShape=e,this.userCode=`
    ...
    `}}function $c(n,e,t){const s=n.indexOf(e);return n.map((r,i)=>i===s?`${r} - ${t}`:r).join()}function vc(n){const{inputs:e,backend:t}=n,{input:s}=e,o=t.texData.get(s.dataId);return Xt({inputs:{x:o.complexTensorInfos.imag},backend:t})}const Dz={kernelName:fu,backendName:"webgl",kernelFunc:vc};function qi(n,e,t){const s=n[0].dtype;if(s==="complex64"){const p=n.map(b=>Hi({inputs:{input:b},backend:t})),f=n.map(b=>vc({inputs:{input:b},backend:t})),m=qi(p,e,t),g=qi(f,e,t),x=As({inputs:{real:m,imag:g},backend:t});return p.forEach(b=>t.disposeIntermediateTensorInfo(b)),f.forEach(b=>t.disposeIntermediateTensorInfo(b)),t.disposeIntermediateTensorInfo(m),t.disposeIntermediateTensorInfo(g),x}let o=t.shouldExecuteOnCPU(n);if(s==="string"&&(o=!0),o){const p=n.map(y=>{const $=[-1,j(y.shape.slice(e))];return se({inputs:{x:y},backend:t,attrs:{shape:$}})}),f=p.map(y=>({vals:t.readSync(y.dataId),shape:y.shape})),m=Pn(p.map(y=>y.shape),1),g=p[0].shape[0]===1,x=kP(f,m,s,g),b=Pn(n.map(y=>y.shape),e),w=t.makeTensorInfo(b,s,x);return p.forEach(y=>t.disposeIntermediateTensorInfo(y)),w}const r=n.filter(p=>j(p.shape)>0),i=V().getBool("WEBGL_PACK_ARRAY_OPERATIONS")&&r[0].shape.length>1;if(r.length===1){const p=i?new Kn(n[0].shape,Es):new Rs(n[0].shape,Es);return t.runWebGLProgram(p,n,s)}const a=V().getNumber("WEBGL_MAX_TEXTURES_IN_SHADER");if(r.length>a){const p=[];for(let m=0;m<r.length;m+=a){const g=r.slice(m,m+a);p.push(qi(g,e,t))}const f=qi(p,e,t);for(const m of p)t.disposeIntermediateTensorInfo(m);return f}if(i){const p=new Az(r.map(f=>f.shape),e);return t.runWebGLProgram(p,r,s)}const{tensors2D:l,outShape:c}=Fz(r,e,t),u=new Rz(l.map(p=>p.shape)),h=t.runWebGLProgram(u,l,s);l.forEach(p=>t.disposeIntermediateTensorInfo(p));const d=se({inputs:{x:h},attrs:{shape:c},backend:t});return t.disposeIntermediateTensorInfo(h),d}function Fz(n,e,t){const s=Pn(n.map(r=>r.shape),e);return{tensors2D:n.map(r=>se({inputs:{x:r},attrs:{shape:[-1,j(r.shape.slice(e))]},backend:t})),outShape:s}}function wy(n){const{inputs:e,backend:t,attrs:s}=n,{axis:o}=s,r=Ce(o,e[0].shape)[0],i=e.map(c=>c.shape);Ph(i,r);const a=Pn(e.map(c=>c.shape),r);if(j(a)===0)return t.makeTensorInfo(a,e[0].dtype,[]);const l=e.filter(c=>j(c.shape)>0);return l.length===1?Xt({inputs:{x:l[0]},backend:t}):qi(l,r,t)}const _z={kernelName:ia,backendName:"webgl",kernelFunc:wy};class Cy{constructor(e,t=!1,s=null,o=!1,r=!1){this.variableNames=["x","W"],this.outputShape=e.outShape;const i=e.padInfo.top,a=e.padInfo.left,l=e.strideHeight,c=e.strideWidth,u=e.dilationHeight,h=e.dilationWidth,d=e.filterHeight,p=e.filterWidth,f=Math.floor(e.inChannels/4)*4,m=e.inChannels%4,g=e.dataFormat==="channelsLast",x=g?1:2,b=g?2:3,w=g?3:1;let y="",C="";s&&(o?y=`float activation(float a) {
   ...
   `;let p="",f="";s&&(o?p=`vec4 activation(vec4 a) {
    ...
    `}}function kc(n,e){const t=n.length;return t>=3?e?[...n.slice(0,-3),n[t-3]*n[t-2],n[t-1]]:[...n.slice(0,-3),n[t-3],n[t-2]*n[t-1]]:!e&&t===1&&n[0]>1?[n[0],1]:null}function $y({x:n,filter:e,convInfo:t,backend:s,bias:o=null,preluActivationWeights:r=null,leakyreluAlpha:i=0,activation:a=null}){const l=n.shape,c=s.texData.get(n.dataId),u=t.inChannels,h=l[0]*l[1]*l[2],d=t.outChannels,p=t.dataFormat==="channelsLast",f=!1,m=!1;let g;const x=[];if(r!=null){const y=kc(r.shape,p);y!=null&&(r=se({inputs:{x:r},backend:s,attrs:{shape:y}}),x.push(r))}if(o!=null){const y=kc(o.shape,p);y!=null&&(o=se({inputs:{x:o},backend:s,attrs:{shape:y}}),x.push(o))}if(!((h===1||d===1)&&u>hy)&&c.isPacked&&p&&c.texture!=null&&l[2]%2!==0&&Re(c.shape.slice(-3),l.slice(-3))){const y=l[0]*l[1]*(l[2]+1),C={dataId:n.dataId,shape:[1,y,t.inChannels],dtype:n.dtype},$=c.shape;c.shape=c.shape.slice(),c.shape[c.shape.length-2]++,k(mc(c.shape,C.shape),()=>`packed reshape ${c.shape} to ${C.shape} isn't free`);const v=se({inputs:{x:e},backend:s,attrs:{shape:[1,t.inChannels,t.outChannels]}});x.push(v);const T=Cc({a:C,b:v,backend:s,transposeA:f,transposeB:m,bias:o,activation:a,preluActivationWeights:r,leakyreluAlpha:i}),N=s.texData.get(T.dataId);k(N.isPacked,()=>"batchMatMul result is expected to be packed"),c.shape=$,N.shape=t.outShape,g=Xt({inputs:{x:T},backend:s}),g.shape=t.outShape,x.push(T)}else{const y=t.outHeight*t.outWidth,C=se({inputs:{x:n},backend:s,attrs:{shape:p?[t.batchSize,y,t.inChannels]:[t.batchSize,t.inChannels,y]}}),$=se({inputs:{x:e},backend:s,attrs:{shape:[1,t.inChannels,t.outChannels]}}),v=Cc({a:p?C:$,b:p?$:C,transposeA:!p,transposeB:m,backend:s,bias:o,activation:a,preluActivationWeights:r,leakyreluAlpha:i});g=se({inputs:{x:v},backend:s,attrs:{shape:t.outShape}}),x.push(C),x.push($),x.push(v)}for(const y of x)s.disposeIntermediateTensorInfo(y);return g}function vy({x:n,filter:e,convInfo:t,backend:s,bias:o=null,preluActivationWeights:r=null,leakyreluAlpha:i=0,activation:a=null}){const{filterWidth:l,filterHeight:c,inChannels:u,outWidth:h,outHeight:d,dataFormat:p}=t,f=p==="channelsLast",m=l*c*u,g=d*h,x=[t.batchSize,m,g],b=!0,w=!1,y=[];if(r!=null){const W=kc(r.shape,f);W!=null&&(r=se({inputs:{x:r},backend:s,attrs:{shape:W}}),y.push(r))}if(o!=null){const W=kc(o.shape,f);W!=null&&(o=se({inputs:{x:o},backend:s,attrs:{shape:W}}),y.push(o))}const C=se({inputs:{x:e},backend:s,attrs:{shape:[1,m,j(e.shape)/m]}});y.push(C);const $=new Lz(x,t),v=[n.shape,[t.padInfo.top,t.padInfo.left],[t.strideHeight,t.strideWidth],[t.dilationHeight,t.dilationWidth],[t.inChannels],[t.filterWidth*t.inChannels],[t.outWidth]],T=s.runWebGLProgram($,[n],"float32",v),N=se({inputs:{x:T},backend:s,attrs:{shape:x}});y.push(T),y.push(N);const S=o!=null,I=r!=null,R=a==="leakyrelu",F=a?Ui(a,!0):null,O=new iy(f?N.shape:C.shape,f?C.shape:N.shape,f?[t.batchSize,g,t.outChannels]:[t.batchSize,t.outChannels,g],b,w,S,F,I,R),L=f?[N,C]:[C,N];if(o&&L.push(o),I&&L.push(r),R){const W=s.makeTensorInfo([],"float32",cs(i,"float32"));L.push(W),y.push(W)}const z=s.runWebGLProgram(O,L,"float32"),U=se({inputs:{x:z},backend:s,attrs:{shape:t.outShape}});y.push(z);for(const W of y)s.disposeIntermediateTensorInfo(W);return U}function Mz(n){const{inputs:e,backend:t,attrs:s}=n,{x:o,filter:r}=e,{strides:i,pad:a,dataFormat:l,dilations:c,dimRoundingMode:u}=s,h=Qn(l),d=yt(o.shape,r.shape,i,c,a,u,!1,h);let p;if(d.filterHeight===1&&d.filterWidth===1&&d.dilationHeight===1&&d.dilationWidth===1&&d.strideHeight===1&&d.strideWidth===1&&(d.padInfo.type==="SAME"||d.padInfo.type==="VALID"))p=$y({x:o,filter:r,convInfo:d,backend:t});else if(d.strideWidth<=2&&h==="channelsLast"&&V().getBool("WEBGL_EXP_CONV")){const m=new Iy(d),g=[[d.padInfo.top,d.padInfo.left],[d.strideHeight,d.strideWidth],[d.dilationHeight,d.dilationWidth],[d.inHeight,d.inWidth]];p=t.runWebGLProgram(m,[o,r],"float32",g)}else if(V().getBool("WEBGL_CONV_IM2COL"))p=vy({x:o,filter:r,convInfo:d,backend:t});else{const m=new Cy(d);p=t.runWebGLProgram(m,[o,r],"float32")}const f=se({inputs:{x:p},backend:t,attrs:{shape:d.outShape}});return t.disposeIntermediateTensorInfo(p),f}const Pz={kernelName:aa,backendName:"webgl",kernelFunc:Mz};class Bz{constructor(e){this.variableNames=["x","dy"],this.outputShape=e.filterShape;const t=e.strideHeight,s=e.strideWidth,o=e.padInfo.top,r=e.padInfo.left,i=e.dataFormat==="channelsLast";this.userCode=`
      void main() {
        ivec4 coords = getOutputCoords();
        int wR = coords.x;
        int wC = coords.y;
...
`}),rV={kernelName:br,backendName:"webgl",kernelFunc:oV};class iV{constructor(e,t,s,o,r){this.variableNames=["Image","Boxes","BoxInd"],this.outputShape=[];const[i,a,l,c]=e,[u]=t,[h,d]=s;this.outputShape=[u,h,d,c];const p=o==="bilinear"?1:0,[f,m]=[`${a-1}.0`,`${l-1}.0`],[g,x,b]=h>1?[`${(a-1)/(h-1)}`,"(y2-y1) * height_ratio",`y1*${f} + float(y)*(height_scale)`]:["0.0","0.0",`0.5 * (y1+y2) * ${f}`],[w,y,C]=d>1?[`${(l-1)/(d-1)}`,"(x2-x1) * width_ratio",`x1*${m} + float(x)*(width_scale)`]:["0.0","0.0",`0.5 * (x1+x2) * ${m}`];this.userCode=`
  ...
  `,p+=`
    ...
    `}}function EV(n){const{inputs:e,backend:t,attrs:s}=n,{x:o,filter:r}=e,{strides:i,pad:a,dilations:l}=s,c=ii(o.shape,r.shape,i,a,"NHWC",l);let u;const h=new TV(c);u=t.runWebGLProgram(h,[o,r],"float32");const d=se({inputs:{x:u},backend:t,attrs:{shape:c.outShape}});return t.disposeIntermediateTensorInfo(u),d}const RV={kernelName:da,backendName:"webgl",kernelFunc:EV};function AV(n){const{inputs:e,backend:t,attrs:s}=n,{equation:o}=s,r=e,{allDims:i,summedDims:a,idDims:l}=Zh(o,r.length);Jh(i.length,l,r);const{path:c,steps:u}=ed(a,l),h=u.length;let d=null,p=i.length;const f=[];for(let m=0;m<h;++m){for(const g of u[m]){const{permutationIndices:x,expandDims:b}=Qh(p,l[g]);let w;td(x)?w=r[g]:(w=Mt({inputs:{x:r[g]},backend:t,attrs:{perm:x}}),f.push(w));const y=w.shape.slice();for(let C=0;C<b.length;++C)y.splice(b[C],0,1);Re(w.shape,y)||(w=se({inputs:{x:w},backend:t,attrs:{shape:y}}),f.push(w)),d===null?d=w:(d=hp({inputs:{a:w,b:d},backend:t}),f.push(d))}m<h-1&&(c[m]>=0&&(d=wc({inputs:{x:d},backend:t,attrs:{axis:c[m]-(i.length-p),keepDims:!1}}),f.push(d)),p--)}for(const m of f)m!==d&&t.disposeIntermediateTensorInfo(m);return d}const DV={kernelName:lu,backendName:"webgl",kernelFunc:AV};const FV=Ne({opSnippet:"return (x >= 0.0) ? x : (exp(x) - 1.0);",packedOpSnippet:`
  vec4 result;
...
`,Ay=Ne({opSnippet:UV,packedOpSnippet:`
  ...
  return result;
`,cpuKernelImpl:NP,dtype:"float32"}),GV={kernelName:Ir,backendName:"webgl",kernelFunc:Ay};function mp(n){const{inputs:e,attrs:t,backend:s}=n,{dim:o}=t,{input:r}=e,i=r.shape.length,a=r.shape.slice();let l=o;return o<0&&(k(-(i+1)<=o,()=>`Axis must be in the interval [${-(i+1)}, ${i}]`),l=i+o+1),a.splice(l,0,1),se({inputs:{x:r},backend:s,attrs:{shape:a}})}const HV={kernelName:fa,backendName:"webgl",kernelFunc:mp};const Dy="return exp(x) - 1.0;",qV=Ne({opSnippet:Dy,packedOpSnippet:Dy,cpuKernelImpl:TP}),jV={kernelName:$r,backendName:"webgl",kernelFunc:qV};class Fy{constructor(e,t,s){this.variableNames=["real","imag"];const o=t[1];this.outputShape=t;const r=s?`2.0 * ${Math.PI}`:`-2.0 * ${Math.PI}`,i=s?`${o}.0`:"1.0";let a;if(e==="real")a="return real * expR - imag * expI;";else if(e==="imag")a="return real * expI + imag * expR;";else throw new Error(`FFT component must be either "real" or "imag", got ${e}.`);this.userCode=`
...
`,dtype:"bool"}),jW={kernelName:$a,backendName:"webgl",kernelFunc:qW};class KW{constructor(e,t,s,o,r){this.variableNames=["x"],this.outputShape=[];const i=t,a=e[3]-1;this.outputShape=e;let l;const c=`float(${s}) + float(${o}) * sum`;r===.5?l=`inversesqrt(${c})`:r===1?l=`1.0/(${c})`:l=`exp(log(${c}) * float(-${r}));`,this.userCode=`
    ...
    `}}const QW={kernelName:mu,backendName:"webgl",kernelFunc:n=>{const{inputs:e,backend:t,attrs:s}=n,{x:o,y:r,dy:i}=e,{depthRadius:a,bias:l,alpha:c,beta:u}=s,h=new ZW(o.shape,a,l,c,u);return t.runWebGLProgram(h,[o,r,i],o.dtype)}};function JW(n,e,t,s){const o=j(e),i=j(n.shape)/o,a=se({inputs:{x:n},attrs:{shape:[i,o]},backend:s}),l=bo(a,n.dtype,"max",s),c=se({inputs:{x:l},attrs:{shape:t},backend:s});return s.disposeIntermediateTensorInfo(a),s.disposeIntermediateTensorInfo(l),c}function My(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{reductionIndices:r,keepDims:i}=s,a=o.shape.length,l=Ce(r,o.shape);let c=l;const u=Ke(c,a),h=u!=null,d=t.shouldExecuteOnCPU([o]);let p=o;if(h){if(d){const w=t.texData.get(p.dataId).values,y=new Array(a);for(let v=0;v<y.length;v++)y[v]=o.shape[u[v]];const C=cp(w,o.shape,o.dtype,u,y);p=t.makeTensorInfo(y,o.dtype);const $=t.texData.get(p.dataId);$.values=C}else p=yc(o,u,t);c=et(c.length,a)}Ct("max",c,a);const[f,m]=gt(p.shape,c);let g=f;i&&(g=rt(f,l));let x;if(d){const w=t.texData.get(p.dataId).values,y=PP(w,j(m),g,o.dtype);x=t.makeTensorInfo(g,o.dtype);const C=t.texData.get(x.dataId);C.values=y}else x=JW(p,m,g,t);return h&&t.disposeIntermediateTensorInfo(p),x}const e4={kernelName:ka,backendName:"webgl",kernelFunc:My};const t4=up+`
  return max(a, b);
`,n4=`
...
`,s4=$t({opSnippet:t4,packedOpSnippet:n4,cpuKernelImpl:BP}),o4={kernelName:Fr,backendName:"webgl",kernelFunc:s4};function r4(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e;Vi(o,"maxPool");const{filterSize:r,strides:i,pad:a,dimRoundingMode:l}=s,c=1;k(Nt(i,c),()=>`Error in maxPool: Either strides or dilations must be 1. Got strides ${i} and dilations '${c}'`);const u=on(o.shape,r,i,c,a,l);if(u.filterWidth===1&&u.filterHeight===1&&Re(u.inShape,u.outShape))return Xt({inputs:{x:o},backend:t});const h=new Gi(u,"max",!1);return t.runWebGLProgram(h,[o],o.dtype)}const i4={kernelName:Sa,backendName:"webgl",kernelFunc:r4};function a4(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{filterSize:r,strides:i,pad:a,dataFormat:l,dimRoundingMode:c}=s,u=[1,1,1],h=Zn(o.shape,r,i,u,a,c,l),d=new dp(h,"max",!1);return t.runWebGLProgram(d,[o],o.dtype)}const l4={kernelName:Na,backendName:"webgl",kernelFunc:a4};class c4{constructor(e){this.variableNames=["dy","maxPos"],this.outputShape=e.inShape;const t=e.strideHeight,s=e.strideWidth,o=e.dilationHeight,r=e.effectiveFilterHeight,i=e.effectiveFilterWidth,a=r-1-e.padInfo.top,l=i-1-e.padInfo.left,c=r*i-1;this.userCode=`
    ...
    `}}function h4(n){const{inputs:e,backend:t,attrs:s}=n,{dy:o,input:r}=e,i=r,{filterSize:a,strides:l,pad:c,dimRoundingMode:u}=s,h=[1,1,1],d=Zn(i.shape,a,l,h,c,u),p=new dp(d,"max",!0),f=t.runWebGLProgram(p,[i],i.dtype),m=new u4(d),g=t.runWebGLProgram(m,[o,f],i.dtype);return t.disposeIntermediateTensorInfo(f),g}const d4={kernelName:xu,backendName:"webgl",kernelFunc:h4};function p4(n){const{inputs:e,backend:t,attrs:s}=n,{dy:o,input:r,output:i}=e,a=r;Vi([r,i],"maxPoolGrad");const{filterSize:l,strides:c,pad:u,dimRoundingMode:h}=s,d=on(a.shape,l,c,1,u,h),p=!0,f=new Gi(d,"max",p),m=t.runWebGLProgram(f,[a],a.dtype),g=new c4(d),x=t.runWebGLProgram(g,[o,m],a.dtype);return t.disposeIntermediateTensorInfo(m),x}const f4={kernelName:gu,backendName:"webgl",kernelFunc:p4};function m4(n,e,t,s){let o=new Gi(t,"max",!1);const r=s.runWebGLProgram(o,[n],"float32");o=new Gi(t,"max",!0,!0,e);const i=s.runWebGLProgram(o,[n],"float32");return[r,i]}const g4={kernelName:Pp,backendName:"webgl",kernelFunc:({inputs:n,attrs:e,backend:t})=>{const{x:s}=n,{filterSize:o,strides:r,pad:i,includeBatchInIndex:a}=e,l=t;k(s.shape.length===4,()=>`Error in maxPool: input must be rank 4 but got rank ${s.shape.length}.`);const c=[1,1];k(Nt(r,c),()=>`Error in maxPool: Either strides or dilations must be 1. Got strides ${r} and dilations '${c}'`);const u=on(s.shape,o,r,c,i),[h,d]=m4(s,a,u,l);return[h,d]}};function x4(n,e,t,s){const o=j(e),i=j(n.shape)/o,a=se({inputs:{x:n},attrs:{shape:[i,o]},backend:s}),l=bo(a,"float32","mean",s),c=se({inputs:{x:l},attrs:{shape:t},backend:s});return s.disposeIntermediateTensorInfo(a),s.disposeIntermediateTensorInfo(l),c}const b4={kernelName:Ta,backendName:"webgl",kernelFunc:({inputs:n,attrs:e,backend:t})=>{const{x:s}=n,{keepDims:o,axis:r}=e,i=t,a=s.shape.length,l=Ce(r,s.shape);let c=l;const u=Ke(c,a),h=u!=null,d=i.shouldExecuteOnCPU([s]),p=[];let f=s;if(h){if(d){const y=i.texData.get(f.dataId).values,C=new Array(a);for(let T=0;T<C.length;T++)C[T]=s.shape[u[T]];const $=cp(y,s.shape,s.dtype,u,C);f=i.makeTensorInfo(C,s.dtype);const v=i.texData.get(f.dataId);v.values=$}else f=yc(s,u,i);p.push(f),c=et(c.length,a)}Ct("sum",c,a);const[m,g]=gt(f.shape,c);let x=m;o&&(x=rt(m,l));const b=x4(f,g,x,i);for(const w of p)i.disposeIntermediateTensorInfo(w);return b}};function y4(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:r,keepDims:i}=s,a=o.shape.length,l=Ce(r,o.shape);let c=l;const u=Ke(c,a);let h=o;u!=null&&(h=Mt({inputs:{x:o},backend:t,attrs:{perm:u}}),c=et(c.length,o.shape.length)),Ct("min",c,a);const[d,p]=gt(h.shape,c),f=j(p),m=se({inputs:{x:h},backend:t,attrs:{shape:[-1,f]}}),g=bo(m,m.dtype,"min",t);let x;if(i){const b=rt(d,l);x=se({inputs:{x:g},backend:t,attrs:{shape:b}})}else x=se({inputs:{x:g},backend:t,attrs:{shape:d}});return t.disposeIntermediateTensorInfo(m),t.disposeIntermediateTensorInfo(g),u!=null&&t.disposeIntermediateTensorInfo(h),x}const w4={kernelName:Ea,backendName:"webgl",kernelFunc:y4};const C4=up+`
  return min(a, b);
`,I4=`
...
`}),SU={kernelName:zr,backendName:"webgl",kernelFunc:kU};class NU{constructor(e,t,s,o,r){this.variableNames=["A"],this.outputShape=[];const[i,a,l,c]=e;this.outputShape=[i,t,s,c];const u=[o&&t>1?a-1:a,o&&s>1?l-1:l],h=[o&&t>1?t-1:t,o&&s>1?s-1:s];let d;r?d="(vec2(yRC) + vec2(0.5)) * effectiveInputOverOutputRatioRC - vec2(0.5)":d="vec2(yRC) * effectiveInputOverOutputRatioRC",this.userCode=`
    ...
    `}}const qU={kernelName:Au,backendName:"webgl",kernelFunc:({inputs:n,attrs:e,backend:t})=>{const{image:s}=n,{radians:o,fillValue:r,center:i}=e,a=t,l=new HU(s.shape,r),[c,u]=zh(i,s.shape[1],s.shape[2]),h=[[c,u,Math.sin(o),Math.cos(o)]];return a.runWebGLProgram(l,[s],s.dtype,h)}};const jU=Ne({opSnippet:`
...
`}),sH={kernelName:Jr,backendName:"webgl",kernelFunc:nH};function oH(n){const{inputs:e,backend:t,attrs:s}=n,{tensor:o,indices:r,updates:i}=e,{sliceRank:a,numUpdates:l,sliceSize:c,strides:u,outputSize:h}=to(i,r,o.shape),d=[h/c,c];if(h===0)return t.makeTensorInfo(o.shape,r.dtype);const p=se({inputs:{x:r},backend:t,attrs:{shape:[l,a]}}),f=se({inputs:{x:i},backend:t,attrs:{shape:[l,c]}}),m=se({inputs:{x:o},backend:t,attrs:{shape:d}}),g=new xp(l,a,p.shape.length,f.shape.length,u,d,!1,!0),x=t.runWebGLProgram(g,[f,p,m],m.dtype),b=se({inputs:{x},backend:t,attrs:{shape:o.shape}});return t.disposeIntermediateTensorInfo(p),t.disposeIntermediateTensorInfo(f),t.disposeIntermediateTensorInfo(m),t.disposeIntermediateTensorInfo(x),b}const rH={kernelName:Gp,backendName:"webgl",kernelFunc:oH};class iH{constructor(e,t){this.variableNames=["A"];const s=new Array(e.length);for(let i=0;i<s.length;i++)s[i]=e[i]*t[i];this.outputShape=s,this.rank=s.length;const o=Pe(this.rank),r=aH(e);this.userCode=`
    ...
    void main() {
     ...
     `}}function yo(n,e){e!==null&&n.disposeIntermediateTensorInfo(e)}function Ky(n){let e=1;for(;e<n;)e*=2;return e}function hH(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{k:r,sorted:i}=s,a=V().getNumber("TOPK_LAST_DIM_CPU_HANDOFF_SIZE_THRESHOLD"),l=V().getNumber("TOPK_K_CPU_HANDOFF_THRESHOLD"),c=o.shape,u=c[c.length-1];if(t.shouldExecuteOnCPU([o])||u<a||r>l){const S=t.readSync(o.dataId),[I,R]=c3(S,c,o.dtype,r,i);return[t.makeTensorInfo(I.shape,I.dtype,I.values),t.makeTensorInfo(R.shape,R.dtype,R.values)]}if(r===0)return c[c.length-1]=0,[t.makeTensorInfo(c,o.dtype,[]),t.makeTensorInfo(c,"int32",[])];if(u===1)return[o,Ki({attrs:{shape:c,dtype:"int32",value:0},backend:t})];const h=t.texData.get(o.dataId),d=h!==null&&h.isPacked,p=d?t.unpackTensor(o):o,m=j(c)/u,g=se({inputs:{x:p},attrs:{shape:[m,u]},backend:t});d&&yo(t,p);const x=Ky(r),b=Ky(u);let w=null;const y=()=>w===null?[g,g]:[g,w],C=(S,I,R)=>{const F=y(),O=new cH(R),z=[[u],[w===null?1:0],[Number.NEGATIVE_INFINITY],[S],[I]],U=w;w=t.runWebGLProgram(O,F,"int32",z),yo(t,U)};for(let S=1;S<x;S*=2){const I=S*2;for(let R=S;R>=1;R/=2)C(I,R,[m,b])}for(let S=b;S>x;S/=2){const I=y(),R=new uH([m,S/2]),O=[[u],[w===null?1:0],[x]],L=w;w=t.runWebGLProgram(R,I,"int32",O),yo(t,L);const z=x/2,U=z*2;for(let W=z;W>=1;W/=2)C(U,W,w.shape)}let $=w;w=or({inputs:{x:w},backend:t,attrs:{begin:0,size:[m,r]}}),yo(t,$);let v=Ly({inputs:{x:g,indices:w},backend:t,attrs:{axis:1,batchDims:1}});yo(t,g);const T=c.slice(0,-1);T.push(r),$=w,w=se({inputs:{x:w},attrs:{shape:T},backend:t}),yo(t,$);const N=v;return v=se({inputs:{x:v},attrs:{shape:T},backend:t}),yo(t,N),[v,w]}const dH={kernelName:Tu,backendName:"webgl",kernelFunc:hH};class pH{constructor(e,t,s,o,r,i){this.variableNames=["Image","Transforms"],this.outputShape=i;const a=s==="nearest"?1:2;let l;switch(o){case"constant":l=1;break;case"reflect":l=2;break;case"wrap":l=3;break;case"nearest":l=4;break;default:l=1;break}this.userCode=`
        ...
        `}}function fH(n){const{inputs:e,backend:t,attrs:s}=n,{image:o,transforms:r}=e,{interpolation:i,fillMode:a,fillValue:l,outputShape:c}=s,[u,h,d,p]=o.shape,[f,m]=c!=null?c:[h,d],g=[u,f,m,p],x=new pH(h,d,i,a,l,g);return t.runWebGLProgram(x,[o,r],"float32")}const mH={kernelName:Eu,backendName:"webgl",kernelFunc:fH};function gH(n){const{inputs:e,attrs:t,backend:s}=n,{axis:o}=t,{x:r}=e;Vi(r,"unique"),console.warn("WARNING: ","UI might be locked temporarily as data is being downloaded");const i=s.readSync(r.dataId),{outputValues:a,outputShape:l,indices:c}=u3(i,o,r.shape,r.dtype);return[s.makeTensorInfo(l,r.dtype,a),s.makeTensorInfo([c.length],"int32",c)]}const xH={kernelName:Ru,backendName:"webgl",kernelFunc:gH};function bH(n){const{inputs:e,backend:t,attrs:s}=n,{value:o}=e;let{axis:r}=s;r<0&&(r+=o.shape.length);const i=o,a=i.shape.length,l=o.shape[r],c=new Array(a-1);let u=0;for(let m=0;m<a;m++)m!==r&&(c[u++]=i.shape[m]);const h=[],d=new Array(a).fill(0),p=i.shape.slice();p[r]=1;const f=new Array(l);for(let m=0;m<f.length;m++){d[r]=m;const g=or({inputs:{x:i},backend:t,attrs:{begin:d,size:p}}),x=se({inputs:{x:g},backend:t,attrs:{shape:c}});f[m]=x,h.push(g)}return h.forEach(m=>t.disposeIntermediateTensorInfo(m)),f}const yH={kernelName:Xa,backendName:"webgl",kernelFunc:bH};class wH{constructor(e,t){this.variableNames=["x","segmentIds"];const s=e.windowSize,o=e.batchSize,r=e.inSize,i=e.numSegments,a=i*Math.ceil(r/s);this.outputShape=[o,a];const l="0.0",c="sumValue",u=Math.floor(s/4)*4,h=s%4,d=`
